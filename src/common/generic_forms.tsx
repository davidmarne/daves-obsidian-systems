...
import Example from "src/eating/components/internal/Datatable";
...
export const dateColumn = <T extends Record<string, any>, P extends keyof T>(): TableFactory<T, P, Moment> => (
  ...
  accessorFn: (it) => {
    console.log("DAVE ACCESSOR", it, property, it[property], it[property].format("gggg-MM-DD"))
        ...
        return factory(property, (rowId, newValue) => {
            ...
            const nextState = state
                .map(item => getRowId(item) === rowId 
                    ...
                    : item);
                console.log("DAVE nextState", nextState)
